...
public class WalkingMushroomModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition leg1 = body.addOrReplaceChild("leg1", CubeListBuilder.create().texOffs(0, 3).addBox(-1.0F, 5.0F, -1.5F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(34, 0).addBox(-1.5F, 4.0F, -2.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, 2.0F, 0.0F));

		PartDefinition bone = leg1.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(6, 15).addBox(0.5F, -1.0F, -2.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 1.0F, 1.0F));

		PartDefinition bone2 = leg1.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(6, 15).addBox(0.5F, 1.0F, -2.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 1.0F, 1.0F));
		...
		PartDefinition leg2 = body.addOrReplaceChild("leg2", CubeListBuilder.create().texOffs(11, 32).addBox(-1.5F, 4.0F, -1.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(0, 0).addBox(-1.0F, 5.0F, -0.5F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, 2.0F, -1.0F));

		PartDefinition bone3 = leg2.addOrReplaceChild("bone3", CubeListBuilder.create(), PartPose.offset(-1.0F, 1.0F, 2.0F));

		PartDefinition bone4 = leg2.addOrReplaceChild("bone4", CubeListBuilder.create(), PartPose.offset(-1.0F, 1.0F, 2.0F));
